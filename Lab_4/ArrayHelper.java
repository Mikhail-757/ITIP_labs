    ...
    public static double calculateAverage(String[] dataArray, int expectedLength) {
        ...
        for (int i = 0; i < expectedLength; i++) {
            try {
                ...
                System.err.printf("Обработано исключение: Выход за границы массива при индексе [%d]. Расчет завершен.\n", i);
                break;
            } catch (NumberFormatException e) {
                System.err.printf("Ошибка данных: Элемент по индексу [%d] не является числом. Игнорируем.\n", i);
            }
        }
